...
def love_life():
    info = {"love": ["love is like a dagger", "love is blind", "love is for the weak", "love is sweet"],
    ...
    print("Hi, I am pretty smart, do you wanna test me out by asking some questions or enter quit to exit")
    ...
    while True:
        ...
        for key, value in info.items():
            if key in question:
                options.append(random.choice(info[key]))
        if options:
            print(random.choice(options))
        else:
            print("No match found..Enter another word")
