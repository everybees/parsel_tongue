...
def register_natives(first_name, last_name, gender, sc_id):
    Native.first_name = first_name
    Native.last_name = last_name
...
class Cohort:
    ...
    def __str__(self):
        return self.cohort_name + " " + self.native
...
def add_native():
    ...
    while number_of_natives < 5:
        Cohort.native.append(register_natives(first_name=input("Enter first name: "), last_name=input("Enter last "
                                                                                                      "name: "),
