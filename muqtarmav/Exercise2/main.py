...
if __name__ == "__main__":
    ...
    cohorts = []
    native1 = class_task.Native("Muqt", "Ade", "M", "SCN01")
    natives1.append(native1)
    native2 = class_task.Native("Ahmed", "Aj", "M", "SCN02")
    natives1.append(native2)
    native3 = class_task.Native("Binta", "Mav", "F", "SCN03")
    native4 = class_task.Native("Tosin", "Emma", "M", "SCN04")
    native5 = class_task.Native("Mac", "Manuel", "F", "SCN05")
    native6 = class_task.Native("Jay", "Lanister", "F", "SCN06")
    native7 = class_task.Native("Sam", "Joe", "M", "SCN09")
    native8 = class_task.Native("Hiqmat", "mav", "F", "SCN07")
