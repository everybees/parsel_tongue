...
while True:
    ...
    if number == 1:
        ...
        print("This is a function that performs addition of 5 numbers in a list")
        print("Total is: ", exercise.sum_of_numbers_in_a_list())
    elif number == 3:
        print("This is a function that performs multiplication of 5 numbers in a list")
        ...
        print("This is a function that calculates the factorial of a number")
        ...
        print("This is a function that generates unique list from pre-existing list")
